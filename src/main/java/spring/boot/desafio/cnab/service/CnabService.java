...
import spring.boot.desafio.cnab.CnabApplication;
...
public class CnabService {
    ...
    private Transacao parseLinha(String linha) {
        ...
        transacao.setHora(LocalTime.parse(linha.substring(43, 48), DateTimeFormatter.ofPattern("HHmmss")));
        transacao.setDonoLoja(linha.substring(49, 62).trim());
        transacao.setNomeLoja(linha.substring(63, 81));
